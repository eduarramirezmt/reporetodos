    ...
    $.ajax (
                {
                    ...
                    url          : 'https://g446a67a49d0026-db202110032149.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/client/client/:id' + id ,
                    type         : 'GET',
                    dataType     : 'json',
    ...
    $.ajax (
                {
                    ...
                    url          : 'https://g446a67a49d0026-db202110032149.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/message/message/:id' + id ,
                    type         : 'GET',
                    dataType     : 'json',
